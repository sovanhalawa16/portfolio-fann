  ...
  return (
    <div className="mx-auto max-w-6xl px-6 lg:px-8 py-12 md:py-16">
      ...
      <div className="mb-10 md:mb-14">
        <div className="h-6 w-20 rounded-full bg-neutral-900/60 animate-pulse mb-5" />
        ...
        <div className="h-4 w-2/3 max-w-lg rounded bg-neutral-900/40 animate-pulse" />
      </div>
      ...
      <div className="flex gap-2 mb-5">
        {[...Array(4)].map((_, i) => (
          <div
            key={i}
            className="h-7 w-20 rounded-full bg-neutral-900/40 animate-pulse"
          />
        ))}
      </div>
